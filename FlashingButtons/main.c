...
void *thread_one(void *arg)
{
    ...
    while(1){
        ...
        // Поток засыпает на 100000 микросекунд, но у меня на 122137 \_(^^)_/
    	xtimer_periodic_wakeup(&last_wakeup_one, 123456);
    }
    return NULL;
}
...
void *thread_two(void *arg)
{
    ...
    while(1){
        ...
        // Поток засыпает на 122137 микросекунд, почему бы и нет:)
xtimer_periodic_wakeup(&last_wakeup_two, 122137);
    }
    return NULL;
}
